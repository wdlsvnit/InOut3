...
/***/ function(module, exports, __webpack_require__) {
				...
				if (data["success"] == 1) {
					...
					if (data.hasOwnProperty('email')) {
						...
						if ($(".error_email").length > 0) {
							$('.error_email').remove();
							$("<div class='error_email'></div>").appendTo("#div_id_email");
							$(".error_email").append('<p id="error_id_email" class="section__content--text"></p>');
							document.getElementById("error_id_email").innerHTML = data["email"][0];
						} else {
							$(".error_email").append('<p id="error_id_email" class="section__content--text"></p>');
							document.getElementById("error_id_email").innerHTML = data["email"][0];
						}
					...
					if (data.hasOwnProperty('name')) {
						...
						if ($(".error_name").length > 0) {
							$('.error_name').remove();
							$("<div class='error_name'></div>").appendTo("#div_id_name");
							$(".error_name").append('<p id="error_id_name" class="section__content--text"></p>');
							document.getElementById("error_id_name").innerHTML = data["name"][0];
						} else {
							$(".error_name").append('<p id="error_id_name" class="section__content--text"></p>');
							document.getElementById("error_id_name").innerHTML = data["name"][0];
						}
	...
	window.onload = function () {
		...
		document.getElementById("signup_submit").onclick = submitForm;
	};
