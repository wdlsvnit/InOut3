...
from inout.views import CustomCallback,UserDash,Index,logout_view,closed,home_view,team_view,campus,tracks,guides,team_approve_view
...
urlpatterns = [
    ...
    url(r'^$',home_view),
    url(r'^new/approve/(?P<team_url_id>(\w{6}))/$',team_approve_view),
